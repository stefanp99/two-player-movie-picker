...
public class Constants {
    ...
    public static final Long MAX_NUMBER_BASE_36 = 1679616L;
    public static final List<String> POPULAR_WATCH_PROVIDER_NAMES =
            List.of("Netflix", "Disney Plus", "Amazon Prime Video", "Apple TV+", "Paramount Plus", "Hulu",
                    "Curiosity Stream", "Crunchyroll", "Max");
